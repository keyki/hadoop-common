...
public class DummyScheduler extends AbstractYarnScheduler
  ...
  Configurable, HeuristicScheduler {
   ...
   * @param cs
   */
  static void schedule(DummyScheduler cs) {
  ...
  static class AsyncScheduleThread extends Thread {
    ...
    private final DummyScheduler cs;
    private AtomicBoolean runSchedules = new AtomicBoolean(false);

    public AsyncScheduleThread(DummyScheduler cs) {
      this.cs = cs;
      setDaemon(true);
    }
