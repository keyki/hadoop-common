...
public class TestExtendedCapacityScheduler {
  ...
  public void testConfValidation() throws Exception {
    ResourceScheduler scheduler = new ExtendedCapacityScheduler();
  ...
  public void testRefreshQueues() throws Exception {
    ExtendedCapacityScheduler cs = new ExtendedCapacityScheduler();
    CapacitySchedulerConfiguration conf = new CapacitySchedulerConfiguration();
  ...
  private void checkQueueCapacities(ExtendedCapacityScheduler cs,
 ...
 * @throws java.io.IOException
  ...
  public void testBlackListNodes() throws Exception {
    ...
    conf.setClass(YarnConfiguration.RM_SCHEDULER, ExtendedCapacityScheduler.class,
        ResourceScheduler.class);
    MockRM rm = new MockRM(conf);
    rm.start();
    ExtendedCapacityScheduler cs = (ExtendedCapacityScheduler) rm.getResourceScheduler();
  ...
  public void testAsyncScheduling() throws Exception {
    ...
    for (int i=0; i < NODES; ++i) {
      ExtendedCapacityScheduler.schedule(cs);
    }
  }
