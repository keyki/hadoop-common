...
public class TestDummyScheduler {
  private static final Log LOG = LogFactory.getLog(TestDummyScheduler.class);
  ...
  public void setUp() throws Exception {
    ...
    conf.setClass(YarnConfiguration.RM_SCHEDULER, DummyScheduler.class, ResourceScheduler.class);
  ...
  public void testConfValidation() throws Exception {
    ResourceScheduler scheduler = new DummyScheduler();
  ...
  @Test
  public void testDummyScheduler() throws Exception {

    LOG.info("--- START: testDummyScheduler ---");
    ...
    LOG.info("--- END: testDummyScheduler ---");
  }
  ...
  public void testRefreshQueues() throws Exception {
    DummyScheduler cs = new DummyScheduler();
    CapacitySchedulerConfiguration conf = new CapacitySchedulerConfiguration();
  ...
  private void checkQueueCapacities(DummyScheduler cs,
 ...
 * @throws java.io.IOException
  ...
  @Test
  public void testDummySchedulerInfo() throws Exception {
  ...
  public void testBlackListNodes() throws Exception {
    ...
    conf.setClass(YarnConfiguration.RM_SCHEDULER, DummyScheduler.class,
        ResourceScheduler.class);
    MockRM rm = new MockRM(conf);
    rm.start();
    DummyScheduler cs = (DummyScheduler) rm.getResourceScheduler();
  ...
  @Test
  public void testAddAndRemoveAppFromDummyScheduler() throws Exception {
